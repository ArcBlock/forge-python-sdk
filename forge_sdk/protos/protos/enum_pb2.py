...
_STATUSCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='sender_withdraw_items_full', index=57, number=64,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='withdraw_item_missing', index=58, number=65,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='invalid_withdraw_tx', index=59, number=66,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='invalid_chain_type', index=60, number=67,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='invalid_time', index=61, number=68,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='invalid_subscribe', index=62, number=69,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_ROLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='role_any', index=11, number=63,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
