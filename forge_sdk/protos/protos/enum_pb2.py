...
_TOPICTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='protocol_state', index=19, number=133,
            serialized_options=None,
            type=None),
    ],
    containing_type=None,
