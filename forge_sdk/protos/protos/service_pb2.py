...
_STATERPC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='get_tether_state',
    full_name='forge_abi.StateRpc.get_tether_state',
    index=5,
    containing_service=None,
    input_type=rpc__pb2._REQUESTGETTETHERSTATE,
    output_type=rpc__pb2._RESPONSEGETTETHERSTATE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='get_swap_state',
...
_STATSRPC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='list_tethers',
    full_name='forge_abi.StatsRpc.list_tethers',
    index=9,
    containing_service=None,
    input_type=rpc__pb2._REQUESTLISTTETHERS,
    output_type=rpc__pb2._RESPONSELISTTETHERS,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='list_swap',
