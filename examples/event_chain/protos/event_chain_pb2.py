...
_TICKETHOLDER.fields_by_name['ticket_create'].message_type = vendor__pb2._TRANSACTION
_TICKETHOLDER.fields_by_name['ticket_exchange'].message_type = vendor__pb2._TRANSACTION
