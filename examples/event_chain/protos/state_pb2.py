...
_FORGESTATE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='data', full_name='forge_abi.ForgeState.data', index=7,
