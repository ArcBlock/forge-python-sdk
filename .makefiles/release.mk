...
RELEASE_URL=https://api.github.com/repos/ArcBlock/forge-python-sdk/releases
...
create-pr:
	...
	@git add version CHANGELOG.md;git commit -a -n -m "bump version";git push origin $(GIT_BRANCH)
	@hub pull-request
