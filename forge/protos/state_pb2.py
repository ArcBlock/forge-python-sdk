...
_FORGESTATE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='data', full_name='forge_abi.ForgeState.data', index=3,
...
ForgeState = _reflection.GeneratedProtocolMessageType(
    'ForgeState', (_message.Message,), dict(
        ...
        StakeSummaryEntry=_reflection.GeneratedProtocolMessageType(
            'StakeSummaryEntry', (_message.Message,), dict(
...
StakeState = _reflection.GeneratedProtocolMessageType(
    'StakeState', (_message.Message,), dict(
