...
_STATUSCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='revoked_tx', index=23, number=29,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='forbidden', index=31, number=403,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='internal', index=32, number=500,
      serialized_options=None,
      type=None),
  ],
